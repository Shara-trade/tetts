...
-- ============================================================
-- 39. ТАБЛИЦА КВЕСТОВ ИГРОКОВ (active_quests) - ТЗ v4.0 п.7
-- ============================================================
CREATE TABLE IF NOT EXISTS active_quests (
    ...
    FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE,
    FOREIGN KEY (quest_code) REFERENCES quest_templates(quest_code) ON DELETE CASCADE
);

CREATE INDEX IF NOT EXISTS idx_active_quests_user ON active_quests(user_id, is_completed);
CREATE INDEX IF NOT EXISTS idx_active_quests_expires ON active_quests(expires_at);
...
-- ============================================================
-- 43. ТАБЛИЦА СТАТИСТИКИ ПОЛЬЗОВАТЕЛЕЙ (user_stats)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS clans (
    ...
    co_leader_ids TEXT, -- JSON array
    member_count INTEGER DEFAULT 1,
    max_members INTEGER DEFAULT 50,
    clan_level INTEGER DEFAULT 1,
    clan_xp INTEGER DEFAULT 0,
    clan_bank INTEGER DEFAULT 0,
    avatar_url TEXT,
    is_open INTEGER DEFAULT 1, -- 1 = открытый, 0 = по приглашению
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE INDEX IF NOT EXISTS idx_clans_tag ON clans(clan_tag);

-- ============================================================
-- 45. ТАБЛИЦА ЧЛЕНОВ КЛАНОВ (clan_members)
-- ============================================================
CREATE TABLE IF NOT EXISTS clan_members (
    member_id INTEGER PRIMARY KEY AUTOINCREMENT,
    clan_id INTEGER NOT NULL,
    user_id INTEGER NOT NULL UNIQUE,
    role TEXT DEFAULT 'member', -- 'leader', 'co_leader', 'elder', 'member'
...
-- ============================================================
-- 46. ТАБЛИЦА ЛОТОВ НА РЫНКЕ (market_listings)
-- ============================================================
CREATE TABLE IF NOT EXISTS market_listings (
    listing_id INTEGER PRIMARY KEY AUTOINCREMENT,
    seller_id INTEGER NOT NULL,
    item_code TEXT NOT NULL,
    item_type TEXT NOT NULL, -- 'seed', 'harvest', 'fertilizer'
    quantity INTEGER DEFAULT 1,
    ...
    FOREIGN KEY (item_code) REFERENCES shop_config(item_code)
);

CREATE INDEX IF NOT EXISTS idx_market_listings_seller ON market_listings(seller_id);
CREATE INDEX IF NOT EXISTS idx_market_listings_item ON market_listings(item_code, is_active);
CREATE INDEX IF NOT EXISTS idx_market_listings_active ON market_listings(is_active, created_at);

-- ============================================================
-- 47. ТАБЛИЦА ТРАНЗАКЦИЙ РЫНКА (market_transactions)
-- ============================================================
CREATE TABLE IF NOT EXISTS market_transactions (
    ...
    seller_earned INTEGER NOT NULL,
...
-- ============================================================
-- 48. ТАБЛИЦА АКТИВНЫХ ПРОМОКОДОВ (active_promocodes) - расширенная
-- ============================================================
CREATE TABLE IF NOT EXISTS active_promocodes (
    promo_id INTEGER PRIMARY KEY AUTOINCREMENT,
    code TEXT UNIQUE NOT NULL,
    name TEXT NOT NULL,
    description TEXT,
    reward_type TEXT NOT NULL, -- 'coins', 'gems', 'item', 'multiplier'
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (reward_item_code) REFERENCES shop_config(item_code),
    FOREIGN KEY (created_by) REFERENCES users(user_id)
);

CREATE INDEX IF NOT EXISTS idx_active_promocodes_code ON active_promocodes(code);
CREATE INDEX IF NOT EXISTS idx_active_promocodes_active ON active_promocodes(is_active, valid_until);

-- ============================================================
-- 49. ТАБЛИЦА АКТИВАЦИЙ ПРОМОКОДОВ (promocode_claims)
-- ============================================================
CREATE TABLE IF NOT EXISTS promocode_claims (
    ...
    reward_given TEXT, -- JSON с информацией о награде
    FOREIGN KEY (promo_id) REFERENCES active_promocodes(promo_id),
    FOREIGN KEY (user_id) REFERENCES users(user_id),
    UNIQUE(promo_id, user_id)
);

CREATE INDEX IF NOT EXISTS idx_promocode_claims_promo ON promocode_claims(promo_id);
CREATE INDEX IF NOT EXISTS idx_promocode_claims_user ON promocode_claims(user_id);

-- ============================================================
-- 50. ТАБЛИЦА УЧАСТНИКОВ СОБЫТИЙ (event_participation)
-- ============================================================
CREATE TABLE IF NOT EXISTS event_participation (
    ...
    score INTEGER DEFAULT 0,
    rank INTEGER,
    rewards_claimed TEXT, -- JSON array
    joined_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
